...
import com.techframe.ecomerce.service.*;
...
public class CategoryProductController {
    ...
    public String productShowTest(@PathVariable int id, Model model, Model model2) {
        model.addAttribute("product", productServiceM.getProductById(id));
        model2.addAttribute("post", postServiceM.listAllPosts());
